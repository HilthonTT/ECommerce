        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "carts:remove", "Member" },
                    { "carts:view", "Administrator" },
                    { "carts:view", "Member" },
                    { "orders:cancel", "Administrator" },
                    { "orders:cancel", "Member" },
                    { "orders:create", "Administrator" },
                    { "orders:create", "Member" },
                    { "orders:ship", "Administrator" },
                    { "orders:view", "Administrator" },
                    { "orders:view", "Member" },
                    { "tickets:chat-assistant", "Administrator" },
                    { "tickets:chat-assistant", "Member" },
                    { "tickets:create", "Administrator" },
                    { "tickets:create", "Member" },
                    { "tickets:update", "Administrator" },
                    { "tickets:update", "Member" },
                    { "tickets:view", "Administrator" },
                    { "tickets:view", "Member" },
                    { "users:read", "Administrator" },
                    { "users:read", "Member" },
                    { "users:update", "Administrator" },
                    { "users:update", "Member" },
                    { "webhooks:create", "Administrator" },
                    { "webhooks:remove", "Administrator" },
                    { "webhooks:update", "Administrator" },
                    { "webhooks:view", "Administrator" }
                });
