...
#pragma warning restore ASPIREINTERACTION001
        ...
        IResourceBuilder<ProjectResource> webApp)
    {
        ...
        IResourceBuilder<OllamaModelResource> embeddings = ollama.AddModel("embedding", "all-minilm");
        IResourceBuilder<OllamaModelResource> chat = ollama.AddModel("chat", "llama3.1");
