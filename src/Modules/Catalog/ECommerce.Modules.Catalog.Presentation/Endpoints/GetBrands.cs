...
using ECommerce.Modules.Catalog.Application.Catalog.GetBrands;
...
internal sealed class GetBrands : IEndpoint
{
    ...
    {
        app.MapGet("catalog/brands", async (
            IQueryHandler<GetBrandsQuery, CollectionResponse<CatalogBrandResponse>> handler,
