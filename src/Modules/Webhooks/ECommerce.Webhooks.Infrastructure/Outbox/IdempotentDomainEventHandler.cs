...
namespace ECommerce.Webhooks.Infrastructure.Outbox;
    ...
    where TDomainEvent : IDomainEvent
{
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            ...
            SELECT EXISTS(
                SELECT 1
                FROM {Schemas.Webhooks}.outbox_message_consumers
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            $"""
            INSERT INTO {Schemas.Webhooks}.outbox_message_consumers(outbox_message_id, name)
